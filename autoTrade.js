...
const {
  ...
  TX_INTERVAL_SECONDS = "90", // base interval (40 transactions per hour, ~1.5 minutes each)
} = process.env;
...
async function main() {
  // Execute trades continuously forever (40 transactions per hour)
  ...
  while (true) {
    ...
    // Jitter the interval so trades are at random times, approximately 40 per hour
